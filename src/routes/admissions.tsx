...
export const Route = createFileRoute("/admissions")({
  head: () => ({
    meta: [
      { title: "Admissions — Green Valley International School" },
      { name: "description", content: "Apply for admission to Green Valley International School for the 2025-26 session." },
    ],
  }),
