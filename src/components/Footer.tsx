        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                <span className="text-lg font-bold font-heading block">Millennium World</span>
                <span className="text-[10px] text-primary-foreground/60 tracking-widest uppercase">School</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 shrink-0" /> Orai, Uttar Pradesh, India</li>
              <li className="flex items-center gap-2"><Phone className="h-4 w-4 shrink-0" /> +91 98765 43210</li>
              <li className="flex items-center gap-2"><Mail className="h-4 w-4 shrink-0" /><span>info@millenniumworldschool.edu</span></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-primary-foreground/10 mt-10 pt-6 text-center text-xs text-primary-foreground/40">
          © {new Date().getFullYear()} Millennium World School. All rights reserved.
        </div>
      </div>
    </footer>
  );
